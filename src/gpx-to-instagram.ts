...
async function main(params: GpxToInstagramParams): Promise<void> {

    if (!params.g.toLowerCase().endsWith('.gpx')) {
        throw new Error('Incorrect GPX file name');
    }
    ...
    if (
        !(
            params.i.toLowerCase().endsWith('.jpg') ||
            params.i.toLowerCase().endsWith('.jpeg') ||
            params.i.toLowerCase().endsWith('.png') ||
            params.i.toLowerCase().endsWith('.gif')
        )
    ) {
        throw new Error('Incorrect image file name');
    }
